...
<script>
    ...
    $(document).ready(function() {
        tableBarang = $('#table-barang').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('barang/list') }}", // URL to fetch data from server
                dataType: "json",
                type: "POST",
                data: function(d) {
                    d.filter_kategori = $('.filter_kategori').val(); // Pass filter value to server
                }
            },
            columns: [
                ...
                { data: "harga_beli", width: "10%", orderable: true, searchable: false, render: function(data) { return new Intl.NumberFormat('id-ID').format(data); }},
                { data: "harga_jual", width: "10%", orderable: true, searchable: false, render: function(data) { return new Intl.NumberFormat('id-ID').format(data); }},
        ...
        // Trigger table redraw when filter changes
